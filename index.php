<html>
<head>
    <title>Voyage en chine</title>
    <meta name="description" content="WEBER Antoine, Voyage en chine">
    <meta charset="utf-8">
    <meta name="apple-mobile-web-app-capable" content="yes">
    <meta name="apple-touch-fullscreen" content="yes">
    <link rel="icon" type="image/png" href="china_flag.png"> 
    <link rel="shortcut icon" type="image/x-icon" href="china_flag.png">
